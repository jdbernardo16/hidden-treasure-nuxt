import{ax as e}from"./Do8AddXw.js";var p=(t=>(t.CANCELLED="CANCELLED",t.CHECKOUT_DRAFT="CHECKOUT_DRAFT",t.COMPLETED="COMPLETED",t.FAILED="FAILED",t.ON_HOLD="ON_HOLD",t.PENDING="PENDING",t.PROCESSING="PROCESSING",t.REFUNDED="REFUNDED",t))(p||{}),$=(t=>(t.EXTERNAL="EXTERNAL",t.GROUPED="GROUPED",t.SIMPLE="SIMPLE",t.VARIABLE="VARIABLE",t.VARIATION="VARIATION",t))($||{}),C=(t=>(t.DATE="DATE",t.IN="IN",t.MENU_ORDER="MENU_ORDER",t.MODIFIED="MODIFIED",t.NAME="NAME",t.NAME_IN="NAME_IN",t.ON_SALE_FROM="ON_SALE_FROM",t.ON_SALE_TO="ON_SALE_TO",t.PARENT="PARENT",t.POPULARITY="POPULARITY",t.PRICE="PRICE",t.RATING="RATING",t.REGULAR_PRICE="REGULAR_PRICE",t.REVIEW_COUNT="REVIEW_COUNT",t.SALE_PRICE="SALE_PRICE",t.SLUG="SLUG",t.TOTAL_SALES="TOTAL_SALES",t))(C||{}),I=(t=>(t.IN_STOCK="IN_STOCK",t.ON_BACKORDER="ON_BACKORDER",t.OUT_OF_STOCK="OUT_OF_STOCK",t))(I||{}),A=(t=>(t.CATEGORY="CATEGORY",t.PABYYEAR="PABYYEAR",t.PASPORTS="PASPORTS",t.POSTFORMAT="POSTFORMAT",t.PRODUCTCATEGORY="PRODUCTCATEGORY",t.PRODUCTTAG="PRODUCTTAG",t.PRODUCTTYPE="PRODUCTTYPE",t.SHIPPINGCLASS="SHIPPINGCLASS",t.TAG="TAG",t.VISIBLEPRODUCT="VISIBLEPRODUCT",t))(A||{});const a=e`
...
${R}`;e`
  ...
  productCategories(
    ...
    ${D}`;e`
    query getProducts($after: String, $slug: [String], $first: Int = 9999, $orderby: ProductsOrderByEnum = NAME) {
  products(
    first: $first
    after: $after
    where: {categoryIn: $slug, visibility: VISIBLE, minPrice: 0, orderby: {field: $orderby, order: ASC}, status: "publish"}
  ) {
    pageInfo {
      hasNextPage
      endCursor
