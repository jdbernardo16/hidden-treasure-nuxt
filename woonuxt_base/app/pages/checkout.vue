...
const payNow = async () => {
    ...
    try {
        if (orderInput.value.paymentMethod.id === 'stripe' && stripe && elements.value) {
            ...
            if (setupIntent)
                orderInput.value.metaData.push({ key: '_stripe_intent_id', value: setupIntent.id });
    ...
    <div class="flex flex-col min-h-[600px]">
        <template v-if="cart && customer">
            ...
            >
                <div class="grid w-full max-w-2xl gap-8 checkout-form md:flex-1">
                    ...
                    <div v-if="!viewer && customer.billing">
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            ...
                            <a href="/my-account" class="text-brand-gold text-semibold">Log in</a>.
                        </p>
                ...
                <OrderSummary>
                    <button
                        class="flex items-center justify-center w-full gap-3 p-3 mt-4 font-semibold text-center text-white rounded-lg shadow-md bg-brand-gold hover:bg-brand-gold/[0.8] disabled:cursor-not-allowed disabled:bg-gray-400"
