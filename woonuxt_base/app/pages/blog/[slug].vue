<template>
    <Head>
        ...
        <Meta
            name="description"
            hid="description"
            :content="blog?.acf?.blog_content?.short_description || ''"
        />
        ...
        <Meta
            property="og:image"
            hid="og:image"
            :content="blog?.acf?.blog_content?.blog_image?.url || ''"
        />
    ...
    <section>
        <div class="max-w-[1440px] m-auto px-4 lg:px-20 py-10 lg:py-16">
            ...
            <div
                class="flex lg:flex-row flex-col justify-between items-start lg:space-y-0 space-y-10 lg:space-x-20"
            >
                <!-- Blog Content -->
                <div class="lg:flex-1">
                    <!-- Image -->
                ...
                <div class="lg:w-[400px]">
                    ...
                    <div class="space-y-6">
                        <template v-if="!morePosts">
                            ...
                            <div
                                class="flex flex-col lg:space-y-0 space-y-4 lg:flex-row lg:space-x-6"
                            >
                                <div
                                    class="w-full lg:w-1/3 aspect-[1/1] bg-gray-200 animate-pulse rounded-lg"
                                ></div>
                        ...
                        <template v-else>
                            ...
                            >
                                <div
                                    class="w-full lg:w-1/3 aspect-[1/1] overflow-hidden rounded-lg"
                                >
                                    <img
                                        quality="80"
                                        loading="lazy"
                                ...
                                <div
                                    class="flex-1 space-y-3 transition group-hover/blog:text-brand-gold"
                                >
                                    ...
                                    <p
                                        ...
                                        v-html="post.acf.blog_content.short_description"
                                    ></p>
                                </div>
                            </nuxt-link>
                        </template>
...
const { data: blog, error } = useFetch<Blog | null>(
    `${API_BASE_URL}/wp-json/wp/v2/posts?slug=${route.params.slug}`,
    {
        query: {
