    ...
    <section class="bg-brand-dark1">
        <div class="max-w-[1440px] m-auto px-4 lg:px-20 lg:pt-20 lg:pb-20 py-10">
            <div class="text-center mb-10 lg:mb-16">
                <p class="artegra text-3xl lg:text-[40px] text-brand-gold animateUp">
                    {{ data?.consignment_header }}
                </p>
            </div>
            <div
                class="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 gap-10 lg:gap-20 mb-10 lg:mb-16"
            >
                <ProductCard
