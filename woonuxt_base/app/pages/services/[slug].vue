...
<template>
    <Head>
        ...
        <Meta
            name="description"
            hid="description"
            :content="stripHtml(data?.frame_2?.service_description) || ''"
        />
    ...
    <section>
        <div class="max-w-[1000px] px-4 mx-auto py-16 text-justify">
            <div
                class="text-xl sm:text-3xl leading-snug wysiwyg"
                v-html="data?.frame_2?.service_description"
            />
        ...
        <div class="max-w-[1000px] mx-auto py-16 space-y-10 lg:space-y-16 px-4">
            <div
                v-for="item in data?.frame_3?.items"
                class="flex flex-col sm:flex-row items-center w-full service-card"
            >
                ...
                <div class="w-full sm:w-1/2 space-y-5 content mt-6 sm:mt-0">
                    ...
                    >
                    <p v-else class="text-2xl sm:text-3xl font-bold artegra text-brand-gold">
                        {{ item?.label }}
                    </p>
        ...
        <div class="max-w-[1000px] mx-auto pb-16 wysiwyg px-4 w-full">
            <div
                class="w-full overflow-x-auto table-responsive"
                v-html="data?.frame_3?.additional_content"
            />
        </div>
    </section>
    ...
    <section class="bg-brand-dark1">
        <div class="max-w-[1000px] mx-auto px-4 sm:px-20 text-center py-16">
            ...
            <div
                class="text-white text-lg sm:text-xl leading-relaxed"
                v-html="data?.frame_4?.content"
            />
