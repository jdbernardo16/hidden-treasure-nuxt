            ...
            :alt="product?.name || 'Product'" /> -->
                    ...
                    <div class="lg:max-w-md xl:max-w-lg md:py-2 w-full">
                        <div class="flex justify-between mb-4 items-start">
                            <div class="flex-1">
                                <h1
                                    class="flex flex-wrap items-center gap-2 mb-2 text-2xl font-sesmibold text-white"
                                >
                                    {{ type.name }}
                                ...
                                <div
                                    v-if="type.salePrice"
                                    class="flex items-center text-white space-x-2 mb-4"
                                >
                                    <p class="text-brand-gold text-2xl">{{ type.salePrice }}</p>
                                    <p class="line-through text-gray-400 text-xl">
                                        {{ type.regularPrice }}
                                    </p>
                                </div>
                        ...
                        <div
                            class="mb-8 font-light prose text-white wysiwyg whitespace-pre-wrap"
                        ...
                        <form @submit.prevent="addToCart(selectProductInput)">
                            ...
                            >
                                <input
                                    v-if="
                                        product.productCategories.nodes[0].slug !== 'sports-cards'
                                    "
                                    v-model="quantity"
                                    type="number"
                                    min="1"
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="product-categories">
                                        <NuxtLink
                                            ...
                                            class="hover:text-brand-gold text-white"
                                            :title="category.name"
                ...
                <div class="my-32" v-if="product.related && storeSettings.showRelatedProducts">
                    <div class="mb-4 text-xl font-semibold text-brand-gold">
                        {{ $t('messages.shop.youMayLike') }}
                    </div>
                    <ProductRow
                        :products="product.related.nodes"
                        class="grid-cols-2 md:grid-cols-4 lg:grid-cols-4"
                    />
                </div>
            </div>
        </div>
