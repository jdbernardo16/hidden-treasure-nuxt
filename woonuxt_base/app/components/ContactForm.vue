            ...
            <div class="max-w-[1080px] m-auto flex flex-col lg:flex-row lg:space-x-20 relative z-10">
                <div class="lg:w-[450px] lg:mb-0 mb-8">
                    ...
                    <div class="text-white">
                        <p>Reach out to Hidden Treasures today and discover how we can transform your brand’s potential
                            into measurable success. We’re here to help you every step of the way.</p>
                    </div>
                </div>
