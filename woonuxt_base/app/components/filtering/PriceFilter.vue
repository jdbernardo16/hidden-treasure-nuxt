...
<template>
  <div>
    <div class="cursor-pointer flex font-semibold mt-8 leading-none justify-between items-center text-brand-gold" @click="isOpen = !isOpen">
    ...
    <div v-show="isOpen" class="mt-3 grid gap-4 grid-cols-2">
      <div class="flex relative items-center">
        <input
          id="price-from"
          v-model="price[0]"
          class="bg-transparent border rounded-lg max-w-full border-brand-gold leading-none w-auto p-2 pl-6 md:text-sm text-white"
          type="number"
          placeholder="From"
          min="0" />
