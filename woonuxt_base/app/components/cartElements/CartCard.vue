        ...
        <div v-if="productType" class="flex items-start gap-3 group">
            ...
            <div class="flex-1">
                <div class="flex gap-x-2 gap-y-1 flex-wrap items-center">
                    <NuxtLink class="leading-tight line-clamp-1" :to="productSlug">{{
                        productType.name
                    }}</NuxtLink>
                    <span
                ...
                <div class="flex items-center space-x-2 text-sm">
                    ...
                    <p
                        v-if="productType.regularPrice"
                        :class="productType.salePrice ? 'line-through text-gray-500' : ''"
                    >
            ...
            <div class="inline-flex gap-2 flex-col items-end">
                <QuantityInput :item />
                <div
                    class="text-xs text-gray-400 group-hover:text-brand-gold flex leading-none items-center"
                >
                    <button
