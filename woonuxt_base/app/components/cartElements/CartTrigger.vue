    ...
    <ClientOnly>
      <Transition name="popIn" mode="out-in">
        <span
          ...
          class="bg-brand-gold rounded-full text-white leading-none min-w-[16px] p-[3px] -top-1 -right-1 md:-right-2 text-[10px] absolute inline-flex justify-center items-center">
