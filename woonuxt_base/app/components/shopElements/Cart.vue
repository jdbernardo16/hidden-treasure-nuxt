...
<template>
    <div
        class="fixed top-0 bottom-0 right-0 z-50 flex flex-col w-11/12 max-w-lg overflow-x-hidden bg-neutral-800 shadow-lg text-brand-gold"
    >
        <Icon
        ...
        <EmptyCart
            ...
            class="rounded-lg shadow-lg p-1.5 hover:bg-brand-gold hover:text-white"
        />
