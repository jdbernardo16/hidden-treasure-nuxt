...
<template>
    <div>
        <h4 v-if="reviews.edges.length" class="font-semibold text-2xl text-gray-900">
            {{ $t('messages.shop.customerReviews') }}
        </h4>
        <h4 v-else class="font-semibold text-2xl text-gray-900">
        ...
        <div class="text-sm mb-4">
            If you have used this product, we would love to hear about your experience.
        </div>
