...
<template>
  <div>
    ...
    <div class="tab-contents">
      <div v-if="show === 0 && product.description" class="font-light mt-8 prose text-white wysiwyg whitespace-pre-wrap" v-html="product.description" />
...
.tabs button.active {
  @apply border-brand-gold text-brand-gold;
}
</style>
