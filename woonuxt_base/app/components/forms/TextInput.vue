<template>
    <div>
        <label :for="id" class="block text-sm text-white mb-1"
            >{{ label
            }}<span v-if="required" class="text-semantic-error ml-0.5"
                >*</span
            ></label
        >
        <div
        ...
        >
            <textarea
                ...
                :id="id"
                :rows="textAreaRows"
                class="block w-full pr-10 focus:outline-none text-sm py-2.5 disabled:text-dark-300 border-0 border-b border-brand-gold resize-none text-white"
                :class="[
                    error
