    ...
    >
        <swiper-slide v-for="(testimonial, index) in items" :key="index">
            <div class="border border-brand-gold p-4 lg:p-16 rounded-2xl lg:rounded-3xl relative">
                ...
                <div
                    class="absolute -bottom-4 lg:-bottom-7 right-4 lg:right-10 bg-brand-dark1 rotate-180"
                >
                    <img class="lg:w-16 w-8" src="/images/quote.svg" alt="quote" />
                </div>
                <div class="w-full bg-brand-gold rounded-2xl lg:rounded-3xl pb-10 px-4 lg:px-10">
                    ...
                    <p class="lg:text-2xl lg:leading-10 text-white mb-6">
                        {{ testimonial.content }}
                    </p>
                    <div
                        class="flex lg:items-end w-full justify-between lg:flex-row flex-col lg:space-y-0 space-y-4"
                    >
                        <div>
                            <p class="text-xl lg:text-3xl text-neutral-700">
                                {{ testimonial.name }}
                            </p>
