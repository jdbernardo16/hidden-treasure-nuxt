            ...
            <div class="h-full relative lg:text-left text-center">
                ...
                >
                    <div class="max-w-full md:max-w-[700px] space-y-8">
                        <h1
                            class="font-bold text-brand-gold text-4xl md:text-[3rem] lg:text-[4rem] leading-tight whitespace-pre-wrap slider-title"
                        >
                            {{ slide.header }}
                        </h1>
                        ...
                        <nuxt-link to="#your-treasures" class="slider-button block">
