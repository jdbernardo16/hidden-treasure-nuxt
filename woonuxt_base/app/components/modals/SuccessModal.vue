    ...
    <BaseModal :show="show" :max-width="maxWidth" @close="$emit('close')">
        <div class="bg-white px-9 py-[60px] rounded-none border">
            <div class="flex flex-col items-center text-center space-y-3 mb-6">
                <div class="w-[48px] h-[48px] flex justify-center items-center bg-brand-gold bg-opacity-10 rounded-full">
                    <Check class="h-5 w-5 stroke-1 stroke-primary-600 text-brand-gold " aria-hidden="true" />
                </div>
