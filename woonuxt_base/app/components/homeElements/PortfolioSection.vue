<template>
    <section class="bg-brand-dark1">
        <div class="max-w-[1440px] m-auto px-4 lg:px-20 py-10 lg:pt-20 lg:pb-20">
            <div
                class="flex w-full justify-between mb-10 items-start lg:flex-row flex-col lg:space-y-0 space-y-4"
            >
                <div class="flex lg:space-x-4 items-start">
                    ...
                    <div>
                        ...
                        <p class="text-white animateUp">
                            Discover how we’ve helped brands uncover their true potential.
                        </p>
                    </div>
                </div>
            ...
            <div id="portfolio" class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                <a
                ...
                >
                    ...
                    <div class="p-5 space-y-3 text-center">
                        ...
                        <p class="text-white text-sm leading-loose line-clamp-3">
                            {{ item.description }}
                        </p>
                    </div>
                </a>
